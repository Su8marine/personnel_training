...
public class Undergraduate implements java.io.Serializable {
	...
	/** minimal constructor */
	public Undergraduate(String stuId, String stuName, Date enrollTime,
			String department, String major, String state) {
		this.stuId = stuId;
	...
	/** full constructor */
	public Undergraduate(String stuId, String stuName, String sex,
			Date birthday, Date enrollTime, String department, String major,
			String grade, String remarks, String state, Date graduateTime,
