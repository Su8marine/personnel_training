...
public class PostGraduate implements java.io.Serializable {
	...
	/** minimal constructor */
	public PostGraduate(String stuId, String stuName, Date enrollTime,
			String department, String major, String teacher, String state) {
		this.stuId = stuId;
	...
	/** full constructor */
	public PostGraduate(String stuId, String stuName, String sex,
			Date birthday, Date enrollTime, String stuSort, String type,
			String department, String major, String grade,
			String researchDirection, String trainSort, String teacher,
			String remarks, String state, Date graduateTime,
			String graduateNum, Date degreeTime, String degreeNum,
			Boolean isEmployed, String graduateDirection) {
		this.stuId = stuId;
		this.stuName = stuName;
		this.sex = sex;
